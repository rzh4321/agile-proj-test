...
router.post('/', async (req : any, res : any) => {
  try {
    ...
    const newStore = new Store({
      ...
      reviews: reviews || ['5_This is definitely world class zoo and a great way to close and personal with animals. Usually a zoo this size is far away from the city center but this zoo is just a short ferry away. The zoo itself is like a scenic hike with a great view of the city. The seal show definitely is the headliner but there are so many different animals to make a great day trip._World Explorer', '5_This is definitely world class zoo and a great way to close and personal with animals. Usually a zoo this size is far away from the city center but this zoo is just a short ferry away. The zoo itself is like a scenic hike with a great view of the city. The seal show definitely is the headliner but there are so many different animals to make a great day trip._World Explorer'],
      categories: categories || ['Uncategorized'],
      priceRange: priceRange || 'Mid-Range',
      description: description || 'Retail chain selling a range of grocery items, meat & dairy.',
      photos: photos || ['https://corporate.target.com/getmedia/d2441ab3-7b0b-4bff-9a6f-15df4690559d/New-Stores_Header_Target.png?width=620'],
      ...
      openingHours: openingHours || `Monday: 9:30 AM – 5:00 PM
